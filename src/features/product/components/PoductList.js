...
const sortOptions = [
  { name: 'Best Rating', sort: 'price', order:'desc', current: false },
...
const filters = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'home-decoration ', label: 'groceries', checked: false }
    ],
  },
  {
    id: 'size',
...
export default function ProductList() {
  ...
  let product=useSelector(selectAllProducts); 
          ...
          <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <section aria-labelledby="products-heading" className="pb-24 pt-6">
              ...
              <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
               ...
               <ProductGrid product={product}></ProductGrid>
                </div>
               {/*  product gride ends here */}
              </div>
            </section>
            ...
            {section.options.map((option, optionIdx) => (
              <div key={option.value} className="flex items-center">
                <input
                  ...
                  type="checkbox"
                  defaultChecked={option.checked}
                  onChange={e=>handleFilter(e,section,option)}/////// lets see
                  className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                />
                <label
...
function ProductGrid({product}){
  return (<>
     <div className="bg-white">
                  <div className="mx-auto max-w-2xl px-2 py-0 sm:px-6 sm:py-0 lg:max-w-7xl lg:px-5">


                    <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                      {(product.length===0)? console.log("not rendered") : ( ( product.map((product) => (
                        
                        <Link to="/ProductDetails">
                          <div key={product.id} className="group relative border-solid border-2 m-4 px-2 w-[111%]  border-gray-200">
                            <div className="aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-md bg-gray-200 lg:aspect-none group-hover:opacity-75 lg:h-80">
                              ...
                              />
                              {/* {console.log("length of the product",product.lenght)} */}
                            </div>
                            <div className="mt-4 flex justify-between">
                              ...
                              <p className="text-sm font-medium block text-gray-500 line-through">
                                ${product.price}
                                </p>
                              </div>
                            </div>
